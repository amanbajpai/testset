package com.keykeeper.app.netcom;
...
public interface Keys {
    ...
    /*Notification Type*/
    int NOTIFICATION_ASSET_REQUEST = 1;
    int NOTIFICATION_ASSET_REQUEST_APPROVE = 2;
    int NOTIFICATION_ASSET_REQUEST_DECLINE = 3;
    ...
    int NOTIFICATION_ASSET_SUBMIT_REQUEST = 7;
    ...
    int NOTIFICATION_HIGH_SPEED_ALERT = 14;
    /**
     * approved request
     */
