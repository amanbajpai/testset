 ...
 */
public class StyledTextViewRegular extends android.support.v7.widget.AppCompatTextView {
...
//    private final String DEFAULT_FONT = "helvetica.ttf";
    ...
    public StyledTextViewRegular(Context context) {
        super(context);
    }

    public StyledTextViewRegular(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public StyledTextViewRegular(Context context, AttributeSet attrs, int defStyle) {
