 ...
 */
public class StyledTextViewSemiBold extends android.support.v7.widget.AppCompatTextView {

    private final String TAG = "StyledTextView";
    private final String DEFAULT_FONT = "Poppins-SemiBold.ttf";
//    private final String DEFAULT_FONT = "helvetica.ttf";

    public StyledTextViewSemiBold(Context context) {
        super(context);
    }

    public StyledTextViewSemiBold(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public StyledTextViewSemiBold(Context context, AttributeSet attrs, int defStyle) {
