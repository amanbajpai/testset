...
public class StyledEditTextView extends EditText {
    ...
    public StyledEditTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public StyledEditTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
