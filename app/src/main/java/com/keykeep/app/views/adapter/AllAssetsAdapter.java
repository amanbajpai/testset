...
public class AllAssetsAdapter extends RecyclerView.Adapter<AllAssetsAdapter.Holder> {

    Context context;
    private AssetsListResponseBean assetLists;

    public AllAssetsAdapter(Context context, AssetsListResponseBean resultAssetList) {
